...
!(function (e, t, i) {
	...
	class o {
		...
		static flatten(e, t = '') {
			...
			for (const n in e) {
				let o = e[n],
					s = t ? `${t}[${n}]` : n;
				Array.isArray(o) ? (i = Object.assign(i, this.flatten(o, s))) : (i[s] = o);
			}
			return i;
		}
	}
	...
	(s.equal = (e, t) => s.addQuery(e, 'equal', t)),
		...
		(s.between = (e, t, i) => `between("${e}", ${s.parseValues(t)}, ${s.parseValues(i)})`),
		...
		(s.addQuery = (e, t, i) =>
			i instanceof Array
				...
				: `${t}("${e}", [${s.parseValues(i)}])`),
		(s.parseValues = (e) => ('string' == typeof e || e instanceof String ? `"${e}"` : `${e}`));
	...
	(e.Account = class extends o {
		...
		get() {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('get', e, { 'content-type': 'application/json' }, {});
			});
		}
		create(e, t, i, o) {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('post', s, { 'content-type': 'application/json' }, n);
			});
		}
		updateEmail(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('patch', n, { 'content-type': 'application/json' }, i);
			});
		}
		listIdentities(e) {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('get', i, { 'content-type': 'application/json' }, t);
			});
		}
		deleteIdentity(e) {
			return n(this, void 0, void 0, function* () {
				if (void 0 === e) throw new r('Missing required parameter: "identityId"');
				const t = '/account/identities/{identityId}'.replace('{identityId}', e),
					i = new URL(this.client.config.endpoint + t);
				return yield this.client.call('delete', i, { 'content-type': 'application/json' }, {});
			});
		}
		createJWT() {
			return n(this, void 0, void 0, function* () {
				const e = new URL(this.client.config.endpoint + '/account/jwt');
				return yield this.client.call('post', e, { 'content-type': 'application/json' }, {});
			});
		}
		listLogs(e) {
			return n(this, void 0, void 0, function* () {
		...
		updateName(e) {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('patch', i, { 'content-type': 'application/json' }, t);
			});
		}
		updatePassword(e, t) {
			return n(this, void 0, void 0, function* () {
		...
		createRecovery(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('post', n, { 'content-type': 'application/json' }, i);
			});
		}
		updateRecovery(e, t, i, o) {
			return n(this, void 0, void 0, function* () {
				...
				if (void 0 === i) throw new r('Missing required parameter: "password"');
				if (void 0 === o) throw new r('Missing required parameter: "passwordAgain"');
				const n = {};
				void 0 !== e && (n.userId = e),
					void 0 !== t && (n.secret = t),
					void 0 !== i && (n.password = i),
				...
				return yield this.client.call('put', s, { 'content-type': 'application/json' }, n);
			});
		}
		listSessions() {
			return n(this, void 0, void 0, function* () {
		...
		deleteSessions() {
			return n(this, void 0, void 0, function* () {
				const e = new URL(this.client.config.endpoint + '/account/sessions');
				return yield this.client.call('delete', e, { 'content-type': 'application/json' }, {});
			});
		}
		createAnonymousSession() {
			return n(this, void 0, void 0, function* () {
				const e = new URL(this.client.config.endpoint + '/account/sessions/anonymous');
				return yield this.client.call('post', e, { 'content-type': 'application/json' }, {});
			});
		}
		createEmailSession(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				const i = {};
				void 0 !== e && (i.email = e), void 0 !== t && (i.password = t);
				const n = new URL(this.client.config.endpoint + '/account/sessions/email');
				return yield this.client.call('post', n, { 'content-type': 'application/json' }, i);
			});
		}
		createMagicURLSession(e, t, i) {
			return n(this, void 0, void 0, function* () {
				...
				if (void 0 === t) throw new r('Missing required parameter: "email"');
				const n = {};
				void 0 !== e && (n.userId = e), void 0 !== t && (n.email = t), void 0 !== i && (n.url = i);
				const o = new URL(this.client.config.endpoint + '/account/sessions/magic-url');
				return yield this.client.call('post', o, { 'content-type': 'application/json' }, n);
			});
		}
		updateMagicURLSession(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				const n = new URL(this.client.config.endpoint + '/account/sessions/magic-url');
				return yield this.client.call('put', n, { 'content-type': 'application/json' }, i);
			});
		}
		createOAuth2Session(e, t, i, n) {
			...
			for (const [e, t] of Object.entries(o.flatten(c))) a.searchParams.append(e, t);
			if (
		...
		createPhoneSession(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				const n = new URL(this.client.config.endpoint + '/account/sessions/phone');
				return yield this.client.call('post', n, { 'content-type': 'application/json' }, i);
			});
		}
		...
		getSession(e) {
			return n(this, void 0, void 0, function* () {
				if (void 0 === e) throw new r('Missing required parameter: "sessionId"');
				const t = '/account/sessions/{sessionId}'.replace('{sessionId}', e),
					i = new URL(this.client.config.endpoint + t);
				return yield this.client.call('get', i, { 'content-type': 'application/json' }, {});
			});
		}
		updateSession(e) {
			return n(this, void 0, void 0, function* () {
				...
				const t = '/account/sessions/{sessionId}'.replace('{sessionId}', e),
					i = new URL(this.client.config.endpoint + t);
				return yield this.client.call('patch', i, { 'content-type': 'application/json' }, {});
			});
		}
		deleteSession(e) {
			return n(this, void 0, void 0, function* () {
		...
		updateStatus() {
			return n(this, void 0, void 0, function* () {
				...
				return yield this.client.call('patch', e, { 'content-type': 'application/json' }, {});
			});
		}
		createVerification(e) {
			return n(this, void 0, void 0, function* () {
				...
				const t = {};
				void 0 !== e && (t.url = e);
				const i = new URL(this.client.config.endpoint + '/account/verification');
				return yield this.client.call('post', i, { 'content-type': 'application/json' }, t);
			});
		}
		updateVerification(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				const i = {};
				void 0 !== e && (i.userId = e), void 0 !== t && (i.secret = t);
				const n = new URL(this.client.config.endpoint + '/account/verification');
				return yield this.client.call('put', n, { 'content-type': 'application/json' }, i);
			});
		}
		createPhoneVerification() {
			return n(this, void 0, void 0, function* () {
				const e = new URL(this.client.config.endpoint + '/account/verification/phone');
				return yield this.client.call('post', e, { 'content-type': 'application/json' }, {});
			});
		}
		updatePhoneVerification(e, t) {
			return n(this, void 0, void 0, function* () {
				...
				const i = {};
				void 0 !== e && (i.userId = e), void 0 !== t && (i.secret = t);
				const n = new URL(this.client.config.endpoint + '/account/verification/phone');
				return yield this.client.call('put', n, { 'content-type': 'application/json' }, i);
			});
		}
	}),
		...
		(e.Avatars = class extends o {
			...
			getFavicon(e) {
				...
				for (const [e, n] of Object.entries(o.flatten(t))) i.searchParams.append(e, n);
				return i;
			}
			getFlag(e, t, i, n) {
				if (void 0 === e) throw new r('Missing required parameter: "code"');
			...
			getImage(e, t, i) {
				if (void 0 === e) throw new r('Missing required parameter: "url"');
				const n = {};
				void 0 !== e && (n.url = e), void 0 !== t && (n.width = t), void 0 !== i && (n.height = i);
				const s = new URL(this.client.config.endpoint + '/avatars/image');
				n.project = this.client.config.project;
				for (const [e, t] of Object.entries(o.flatten(n))) s.searchParams.append(e, t);
				return s;
			}
			getInitials(e, t, i, n) {
				const s = {};
				...
				for (const [e, t] of Object.entries(o.flatten(s))) r.searchParams.append(e, t);
				return r;
			}
			getQR(e, t, i, n) {
				...
				s.project = this.client.config.project;
				for (const [e, t] of Object.entries(o.flatten(s))) c.searchParams.append(e, t);
				return c;
			}
		}),
		(e.Client = class {
				...
				(this.config = {
					...
					(this.realtime = {
						...
						createSocket: () => {
							...
							const n = this.config.endpointRealtime + '/realtime?' + i.toString();
							(n !== this.realtime.url ||
								!this.realtime.socket ||
								(null === (e = this.realtime.socket) || void 0 === e ? void 0 : e.readyState) >
									WebSocket.OPEN) &&
								(this.realtime.socket &&
									(null === (t = this.realtime.socket) || void 0 === t ? void 0 : t.readyState) <
										WebSocket.CLOSING &&
								...
								this.realtime.socket.addEventListener('close', (e) => {
									...
									if (
										...
										('error' ===
											(null ===
												(i =
													null === (t = this.realtime) || void 0 === t ? void 0 : t.lastMessage) ||
											void 0 === i
												? void 0
												: i.type) &&
											1008 ===
												(null === (n = this.realtime) || void 0 === n ? void 0 : n.lastMessage.data)
													.code)
									)
										return void (this.realtime.reconnect = !0);
									const o = this.realtime.getTimeout();
									console.error(
										`Realtime got disconnected. Reconnect will be attempted in ${o / 1e3} seconds.`,
										e.reason
									),
										setTimeout(() => {
						...
						onMessage: (e) => {
							...
							try {
								...
								switch (((this.realtime.lastMessage = n), n.type)) {
									case 'connected':
										const e = JSON.parse(
												null !== (t = window.localStorage.getItem('cookieFallback')) && void 0 !== t
													? t
													: '{}'
											),
											o = null == e ? void 0 : e[`a_session_${this.config.project}`],
											s = n.data;
										o &&
											!s.user &&
											(null === (i = this.realtime.socket) ||
												void 0 === i ||
												i.send(JSON.stringify({ type: 'authentication', data: { session: o } })));
										break;
									case 'event':
										let r = n.data;
										if (null == r ? void 0 : r.channels) {
											if (!r.channels.some((e) => this.realtime.channels.has(e))) return;
				...
				return n(this, void 0, void 0, function* () {
					...
					if (
						('undefined' != typeof window &&
							...
							(s['X-Fallback-Cookies'] =
								null !== (a = window.localStorage.getItem('cookieFallback')) && void 0 !== a
									? a
									: ''),
						'GET' === e)
					)
						for (const [e, i] of Object.entries(o.flatten(c))) t.searchParams.append(e, i);
					else
					...
					try {
						...
						if (
							...
							throw new r(null == e ? void 0 : e.message, o.status, null == e ? void 0 : e.type, e);
		...
		(e.Databases = class extends o {
			...
			listDocuments(e, t, i) {
				return n(this, void 0, void 0, function* () {
					if (void 0 === e) throw new r('Missing required parameter: "databaseId"');
					if (void 0 === t) throw new r('Missing required parameter: "collectionId"');
					const n = '/databases/{databaseId}/collections/{collectionId}/documents'
							.replace('{databaseId}', e)
							.replace('{collectionId}', t),
						o = {};
					void 0 !== i && (o.queries = i);
					const s = new URL(this.client.config.endpoint + n);
					return yield this.client.call('get', s, { 'content-type': 'application/json' }, o);
				});
			}
			createDocument(e, t, i, o, s) {
				return n(this, void 0, void 0, function* () {
					if (void 0 === e) throw new r('Missing required parameter: "databaseId"');
					if (void 0 === t) throw new r('Missing required parameter: "collectionId"');
					if (void 0 === i) throw new r('Missing required parameter: "documentId"');
					...
					return yield this.client.call('post', a, { 'content-type': 'application/json' }, c);
				});
			}
			getDocument(e, t, i, o) {
				return n(this, void 0, void 0, function* () {
					...
					if (void 0 === t) throw new r('Missing required parameter: "collectionId"');
					if (void 0 === i) throw new r('Missing required parameter: "documentId"');
					const n = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}'
							.replace('{databaseId}', e)
							.replace('{collectionId}', t)
					...
					return yield this.client.call('get', c, { 'content-type': 'application/json' }, s);
				});
			}
			updateDocument(e, t, i, o, s) {
				return n(this, void 0, void 0, function* () {
					...
					const a = new URL(this.client.config.endpoint + n);
					return yield this.client.call('patch', a, { 'content-type': 'application/json' }, c);
				});
			}
			deleteDocument(e, t, i) {
				return n(this, void 0, void 0, function* () {
					...
					return yield this.client.call('delete', o, { 'content-type': 'application/json' }, {});
				});
			}
		}),
		(e.Functions = class extends o {
			...
			listExecutions(e, t, i) {
				return n(this, void 0, void 0, function* () {
					if (void 0 === e) throw new r('Missing required parameter: "functionId"');
					const n = '/functions/{functionId}/executions'.replace('{functionId}', e),
						o = {};
			...
			createExecution(e, t, i, o, s, c) {
				return n(this, void 0, void 0, function* () {
					...
					return yield this.client.call('post', d, { 'content-type': 'application/json' }, a);
				});
			}
			getExecution(e, t) {
				return n(this, void 0, void 0, function* () {
					if (void 0 === e) throw new r('Missing required parameter: "functionId"');
					if (void 0 === t) throw new r('Missing required parameter: "executionId"');
					...
					return yield this.client.call('get', n, { 'content-type': 'application/json' }, {});
				});
			}
		}),
		...
		(e.Locale = class extends o {
			...
			listCountriesEU() {
				return n(this, void 0, void 0, function* () {
					const e = new URL(this.client.config.endpoint + '/locale/countries/eu');
					return yield this.client.call('get', e, { 'content-type': 'application/json' }, {});
				});
			}
			listCountriesPhones() {
				return n(this, void 0, void 0, function* () {
					const e = new URL(this.client.config.endpoint + '/locale/countries/phones');
					return yield this.client.call('get', e, { 'content-type': 'application/json' }, {});
				});
			}
			listCurrencies() {
		...
		(e.Storage = class extends o {
			...
			listFiles(e, t, i) {
				return n(this, void 0, void 0, function* () {
					...
					const n = '/storage/buckets/{bucketId}/files'.replace('{bucketId}', e),
						o = {};
					void 0 !== t && (o.queries = t), void 0 !== i && (o.search = i);
					const s = new URL(this.client.config.endpoint + n);
					return yield this.client.call('get', s, { 'content-type': 'application/json' }, o);
			...
			createFile(e, t, i, s, c = (e) => {}) {
				return n(this, void 0, void 0, function* () {
					...
					const d = new URL(this.client.config.endpoint + n);
					if (!(i instanceof File)) throw new r('Parameter "file" has to be a File.');
					const l = i.size;
					if (l <= o.CHUNK_SIZE)
						return yield this.client.call('post', d, { 'content-type': 'multipart/form-data' }, a);
			...
			updateFile(e, t, i, o) {
				return n(this, void 0, void 0, function* () {
					...
					const c = new URL(this.client.config.endpoint + n);
					return yield this.client.call('put', c, { 'content-type': 'application/json' }, s);
				});
			}
			deleteFile(e, t) {
				return n(this, void 0, void 0, function* () {
					...
					const i = '/storage/buckets/{bucketId}/files/{fileId}'
							...
							.replace('{fileId}', t),
						n = new URL(this.client.config.endpoint + i);
					return yield this.client.call('delete', n, { 'content-type': 'application/json' }, {});
				});
			}
			getFileDownload(e, t) {
				if (void 0 === e) throw new r('Missing required parameter: "bucketId"');
			...
			getFilePreview(e, t, i, n, s, c, a, d, l, p, u, h, f) {
				...
				for (const [e, t] of Object.entries(o.flatten(w))) m.searchParams.append(e, t);
				return m;
			}
			getFileView(e, t) {
				if (void 0 === e) throw new r('Missing required parameter: "bucketId"');
		...
		(e.Teams = class extends o {
			...
			list(e, t) {
				return n(this, void 0, void 0, function* () {
					...
					return yield this.client.call('get', n, { 'content-type': 'application/json' }, i);
				});
			}
			create(e, t, i) {
				return n(this, void 0, void 0, function* () {
			...
			updateName(e, t) {
				return n(this, void 0, void 0, function* () {
					...
					return yield this.client.call('put', o, { 'content-type': 'application/json' }, n);
				});
			}
			delete(e) {
				return n(this, void 0, void 0, function* () {
			...
			createMembership(e, t, i, o, s, c, a) {
				return n(this, void 0, void 0, function* () {
					...
					return yield this.client.call('post', l, { 'content-type': 'application/json' }, d);
				});
			}
			getMembership(e, t) {
				return n(this, void 0, void 0, function* () {
					if (void 0 === e) throw new r('Missing required parameter: "teamId"');
					if (void 0 === t) throw new r('Missing required parameter: "membershipId"');
			...
			updateMembership(e, t, i) {
				return n(this, void 0, void 0, function* () {
					...
					void 0 !== i && (o.roles = i);
					const s = new URL(this.client.config.endpoint + n);
					return yield this.client.call('patch', s, { 'content-type': 'application/json' }, o);
				});
			}
			...
			updateMembershipStatus(e, t, i, o) {
				return n(this, void 0, void 0, function* () {
					...
					const c = new URL(this.client.config.endpoint + n);
					return yield this.client.call('patch', c, { 'content-type': 'application/json' }, s);
				});
			}
			getPrefs(e) {
				return n(this, void 0, void 0, function* () {
