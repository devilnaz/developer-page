									...
									<div class="card-info__inner">
										...
										<div class="card-info__content">
											...
											<p class="card-info__note">
												...
												сервисы и сайты по теме разработки. Указал только основопалагающие
												источники, которыми пользовался часто, либо систематически из которых
												получал знания.
											</p>
										</div>
									</div>
												...
												<li class="card-info__item">
													...
													<div class="card-info__content-body">
														<p class="card-info__text" data-text="read">
															...
															it-park. Занимался верстанием элементов с подстройкой под дизайн
															сайта. Внедрял в самописный движок. Мой первый опыт работы в команде с
															методологией Канбан.
														</p>
													</div>
												</li>
												<li class="card-info__item">
													...
													<div class="card-info__content-body">
														<p class="card-info__text" data-text="read">
															...
															Первый язык Python отлично подошел для понимания основ
															программирования на другом языке. Хотя странностей в JS оказалось чуть
															больше. Проходил курсы, практиковался на pet проектах, решал
															задачники. Параллельно подрабатывал на фрилансе.
														</p>
													</div>
												</li>
												<li class="card-info__item">
													...
													<div class="card-info__content-body">
														<p class="card-info__text" data-text="read">
															...
															<br />
															В данной компании занимаюсь разработкой и внедрением нового
															функционала. Дорабатываю текущий функционал, устраняю баги и делаю
															рефакторинг кода. Ответственнен за любые изменения и манипуляции по
															сайту. Выполняю персональные фронтенд доработки для отдельных
															программ, по дополнительной услуги от клиентов.
															<br />
												...
												<li class="card-info__item">
													...
													<div class="card-info__content-body">
														<p class="card-info__text" data-text="read">
															...
															создавалась на стороне CRM программы. Установил Яндекс Метрику и
															связал с кодом формы. Добавил актуальную навигацию и подвал при
															внедрении страницы под движок mstl.
														</p>
												...
												<li class="card-info__item">
													...
													<div class="card-info__content-body">
														<p class="card-info__text" data-text="read">
															...
															подтверждением через СМС. Личным желанием было написать на чистом JS
															без использования библиотек, но под конец, сроки подтолкнули к
															jquery:)<br />
															<br />
															Особенности:<br />
												...
												<li class="card-info__item">
													...
													<div class="card-info__content-body">
														<p class="card-info__text" data-text="read">
															...
															проблема в отображении ckeditor, происходили ошибки в js, не
															отрабатывал плагин на jquery.<br />
															Пробовал скачать страницы другими способами, но в каждом, если уходила
															одна проблема, то появлялась другая. Поэтому выбрал оптимальный
															вариант, затем устранил недочеты в местах, где планировалось добавить
															доработки. Показал список печати во всех форматах. После реализовал
															ряд доработок по внешнему виду. По памяти из ощутимых, поменял список
															в окне на скрол(перестроил данный участок, добавил иконки), добавил
															блок "Табличные значения" с кнопкой "Копировать", изменение блока
															"Загрузить файл" и т.д.
														</p>
														<div class="card-info__wrapper-img">
															<img
																class="card-info__img"
